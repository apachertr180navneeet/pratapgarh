                ...
                <div class="card-body">
                    <form>
                        <div class="row g-3">
                            ...
                            @if(!empty($student->application_no))
                                <div class="col-md-6">
                            ...
                            @if(!empty($student->category_name))
                                <div class="col-md-6">
                            ...
                            @if(!empty($student->mbc_candidate))
                                <div class="col-md-6">
                            ...
                            @if(!empty($student->minority_cast))
                                <div class="col-md-6">
                            ...
                            {{-- Current Address --}}
                            @if(!empty($student->current_address))
                                <div class="col-12">
                            ...
                            @if(!empty($student->current_state))
                                <div class="col-md-4">
                            ...
                            @if(!empty($student->current_district))
                                <div class="col-md-4">
                            ...
                            @if(!empty($student->current_tehsil))
                                <div class="col-md-4">
                            ...
                            @if(!empty($student->current_pincode))
                                <div class="col-md-6">
                            ...
                            @if(!empty($student->permanent_state))
                                <div class="col-md-4">
                            ...
                            @if(!empty($student->permanent_pincode))
                                <div class="col-md-4">
                            ...
                            {{-- Subjects --}}
                            @if(!empty($student->compulsary_subject))
                                <div class="col-md-6">
                            ...
                            @if(!empty($student->final_subject))
                                <div class="col-md-6">
                            ...
                            @for($i=1; $i<=7; $i++)
                                @php $field = 'subject_combination_'.$i; @endphp
                                @if(!empty($student->$field))
                                    <div class="col-md-6">
                                        <label class="form-label">Subject Combination {{ $i }}</label>
                                        <input type="text" class="form-control" value="{{ $student->$field }}" readonly>
                                    </div>
                                @endif
                            @endfor

                            {{-- Other Participation --}}
                            @if(!empty($student->bpl))
                                <div class="col-md-6"><label class="form-label">BPL</label><input type="text" class="form-control" value="{{ $student->bpl }}" readonly></div>
                            @endif

                            @if(!empty($student->willingness_to_join_professional_course))
                            ...
                            @if(!empty($student->{'12th_percentage'}))
                            ...
                            @if(!empty($student->human_right_cell))
                        ...
                        <form action="" method="POST" target="_blank">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" name="aadhaar_card" accept="image/*,.pdf">
                                    @if(!empty($student->aadhaar_card))
                                        <a href="{{ asset('uploads/aadhaar/'.$student->aadhaar_card) }}" target="_blank" class="btn btn-sm btn-primary mt-2">View Uploaded Aadhaar</a>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" class="form-control" name="marksheet" accept="image/*,.pdf">
                                    @if(!empty($student->marksheet))
                                        <a href="{{ asset('uploads/marksheet/'.$student->marksheet) }}" target="_blank" class="btn btn-sm btn-success mt-2">View Uploaded Marksheet</a>
                                    @endif
                                </div>
                            </div>
